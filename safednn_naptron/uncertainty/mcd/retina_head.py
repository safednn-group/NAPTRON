...
class MCDRetinaHead(RetinaHead):
    ...
    def __init__(self, dropout_rates=(0., 0., 0., 0., 0.1), num_forward_passes=20, *args, **kwargs):
        super(MCDRetinaHead, self).__init__(
            *args,
            **kwargs)
    ...
    def simple_test_bboxes(self, feats, img_metas, rescale=False):
        ...
        cls_scores, bbox_preds, label_uncertainty = self.mcd_uncertainty(cls_scores_mcd, bbox_preds_mcd)

        results_list = self.get_bboxes(
            cls_scores, bbox_preds, label_uncertainty, img_metas=img_metas, rescale=rescale)
        return results_list
